...
public class JFontChooser extends JComponent {
    ...
    private static final Font DIALOG_FONT = new Font("Dialog", Font.PLAIN, 10);
    private static final int[] FONT_STYLE_CODES = {Font.PLAIN, Font.BOLD, Font.ITALIC, Font.BOLD | Font.ITALIC};
    private static final String[] DEFAULT_FONT_SIZES = {"10", "11", "12", "14", "16", "18", "20", "22", "24", "36", "48", "72",};
    protected int dialogResultValue = ERROR_OPTION;
    private String[] fontStyleNames, fontFamilyNames, fontSizeStrings = null;
    private JTextField fontFamilyTextField, fontStyleTextField, fontSizeTextField, sampleText = null;
    private JList fontNameList, fontStyleList, fontSizeList = null;
    private JPanel fontNamePanel, fontStylePanel, fontSizePanel, samplePanel = null;
    ...
    public static Font showDialog(JFrame parent, Font defaultFont) {
        ...
        int result = dlg.showDialogToUser(parent);
    ...
    public JFontChooser() {
        fontSizeStrings = DEFAULT_FONT_SIZES;
        ...
        this.setSelectedFont(defFont);
    }
    public int showDialogToUser(JFrame parent) {
    ...
    protected JDialog createDialog(JFrame parent) {
        Frame frame = parent instanceof Frame ? (Frame) parent : (Frame) SwingUtilities.getAncestorOfClass(Frame.class, parent);
        JDialog dialog = new JDialog(frame, "Select Font", true);
        Action okAction = new DialogOKAction(dialog);
        Action cancelAction = new DialogCancelAction(dialog);
        JButton okButton = new JButton(okAction);
        okButton.setFont(DIALOG_FONT);
        JButton cancelButton = new JButton(cancelAction);
        cancelButton.setFont(DIALOG_FONT);
    ...
    public JTextField getFontFamilyTextField() {
        if (fontFamilyTextField == null) {
            ...
            fontFamilyTextField.setFont(DIALOG_FONT);
        }
    ...
    public JTextField getFontStyleTextField() {
        if (fontStyleTextField == null) {
            ...
            fontStyleTextField.setFont(DIALOG_FONT);
        }
    ...
    public JTextField getFontSizeTextField() {
        if (fontSizeTextField == null) {
            ...
            fontSizeTextField.setFont(DIALOG_FONT);
        }
    ...
    public JList getFontFamilyList() {
        if (fontNameList == null) {
            ...
            fontNameList.setFont(DIALOG_FONT);
    ...
    public JList getFontStyleList() {
        if (fontStyleList == null) {
            ...
            fontStyleList.setFont(DIALOG_FONT);
    ...
    public JList getFontSizeList() {
        if (fontSizeList == null) {
            ...
            fontSizeList.setFont(DIALOG_FONT);
    ...
    protected JPanel getSamplePanel() {
        if (samplePanel == null) {
            Border titledBorder = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Preview Text");
    ...
    protected JTextField getSampleTextField() {
        if (sampleText == null) {
            ...
            sampleText = new JTextField("The quick brown fox jumps over the lazy dog. 1234567890");
            sampleText.setBorder(lowered);
            sampleText.setPreferredSize(new Dimension(400, 100));
        }
        return sampleText;
    }
